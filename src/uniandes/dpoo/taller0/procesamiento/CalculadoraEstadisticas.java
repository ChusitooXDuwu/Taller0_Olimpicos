...
public class CalculadoraEstadisticas
{
	...
	public String paisdeunatleta(String nombreAtleta)
	{
		...
		////System.out.println((atleta == atleta_explor.darNombre()));
		//System.out.println(atleta + "//" + atleta_explor);
		//System.out.println(atleta_explor.darPais().darNombre());

		///if (atleta == atleta_explor.darNombre())

		///{	
			///System.out.println("entro al if");
			///x = atleta_explor.darPais().darNombre();
